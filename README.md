...
- Marks branches containing patches not found in the current `HEAD` with a yellow dot.
- Recognizes patch-equivalent squash, cherry-pick, and rebase histories when Git can match the individual commits.
